<template>
  <div class="relative">
    ...
    >
      <img :src="`/assets/images/flags/4x3/${locale}.svg`" alt="flag" class="w-8 h-8">
    ...
    <transition name="dropdown-fade">
      <ul v-if="isVisible" ref="dropdown" class="
      absolute normal-case z-30 font-normal xs:left-0 lg:right-0   rounded w-48 border mt-2 py-1 lg:z-20
        ...
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="/assets/images/flags/4x3/en.svg" alt="english flag" class="h-8 w-8">
        ...
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="/assets/images/flags/4x3/fr.svg" alt="french flag" class="h-8 w-8">
        ...
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="/assets/images/flags/4x3/es.svg" alt="espanish flag" class="h-8 w-8">
