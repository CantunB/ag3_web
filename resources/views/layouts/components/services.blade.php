<section class="section mt-6 services" id="servicios">
    <div class="container">
        <h1 class="section-title text-center mb-4"><span>Servicios</span> que ofrecemos</h1>

        <div class="services-content">
            <div class="row">
                <div class="col-md-2 col-lg-2 d-flex flex-column justify-content-between m-3">
                ...
                <div class="col-md-2 col-lg-2 d-flex flex-column justify-content-between m-3">
                    <img src="{{ asset('assets/images/wedding.svg') }}" alt="transfer">
