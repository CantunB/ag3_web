                   ...
                   <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                       <li class="nav-item">
                           <a class="nav-link" aria-current="page"
                               href="{{ route('index', app()->getLocale()) }}">{{ __('inicio') }}</a>
                       </li>
                       <li class="nav-item">
                   ...
                   <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                       <li class="nav-item dropdown m-2">
                           <language-switcher locale="{{ app()->getLocale() }}"
                               ...
                               link-es="{{ route(Route::currentRouteName(), 'es') }}"></language-switcher>
                       </li>
           ...
           <form class="row my-2" action="{{ route('vehicles', app()->getLocale()) }}" method="POST"
               ...
               <div class="col-lg-2 mb-2" id="date-content">
                   <div class="input-group">
                       ...
                       <input style="background: #FFFFFF;" type="text" class="form-control search_input_3 selector"
                           aria-describedby="icon-date" placeholder="{{ __('fecha') }}" name="date" id="date_arrival"
                           required>
                   </div>
               </div>
