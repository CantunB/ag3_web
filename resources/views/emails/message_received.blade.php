    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="middle" class="hero bg_white" style="padding: 2em 0 2em 0;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="100%" style="padding: 0 2.5em; text-align: center;">
                        <div class="text">
                            <h1 style="color: #EED54A"><strong>SOLICITUD DE CONTACTO</strong></h1>
                        </div>
            		</td>
            	</tr>
                <tr>
            		<td width="50%" style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<p style="color: black">NOMBRE:</p>
            			</div>
                        <span style="color: blue">{{ 'Nombre del destinatario' ?? $msg['name'] }} </span>
            		</td>
            	</tr>
                <tr>
                    <td style="padding: 0 2.5em; text-align: left;">
                        <div class="text">
                            <p style="color: black">CORREO ELECTRONICO:</p>
                        </div>
                        <span style="color: blue">{{ 'Correo del destinatario' ?? $msg['email'] }}</span>
                    </td>
            	</tr>
                <tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<p style="color: black">TELEFONO:</p>
            			</div>
                        <span style="color: blue">{{ 'Telefono del destinatario' ?? $msg['phone'] }}</span>
                ...
                <tr>
            		<td style="padding: 0 2.5em; text-align: left;">
                        ...
                        <span style="color: blue">{{ 'Asunto del destinatario' ?? $msg['subject'] }}</span>
                ...
                <tr>
            		<td style="padding: 0 2.5em; text-align: left;">
                        ...
                        <span style="color: blue">{{ 'Mensa del destinatario' ?? $msg['content']  }}</span>

            		</td>
            	</tr>
                <tr>
            		<td valign="middle" style="text-align:center; padding: 1em 2.5em;">
                        <p><a  href="http://ag3.stigmacode.com/es" class="btn btn-primary"><strong>RESPONDER</strong></a></p>
                    </td>
            	</tr>
            </table>
            </td>
