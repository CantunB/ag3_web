...
<body>
    ...
    <center>
        <table cellspacing="0" cellpadding="0" class="email-content" style="width: 90%; margin-top: 20px; margin-bottom: 20px;">
                    ...
                    <table cellspacing="0" cellpadding="0" class="info-content" style="table-layout: fixed; width: 100%; font-size: 16px;">
                        <tr>
                            <td class="items" style="word-wrap: break-word; border: 2px solid #FACC01; padding: 10px;">
                                <span style="font-weight: bold;">NOMBRE:</span> Jose Felix Hernandez Ortiz<br>
                                <span style="font-weight: bold;">CORREO:</span> resywolut@mailinator.com<br>
                                <span style="font-weight: bold;">TELEFONO:</span> +1 (836) 326-7577<br>
                                <span style="font-weight: bold;">PAIS:</span> Mexico<br>
                                <span style="font-weight: bold;">ESTADO:</span> Campeche<br>
                                <span style="font-weight: bold;">SERVICIO:</span> Aeropuerto a Hotel<br>
                                <span style="font-weight: bold;">DESTINO:</span> ALTITUDE BY KRYSTAL GRAND PUNTA CANCUN<br>
                                <span style="font-weight: bold;">VEHICULO SOLICITADO:</span> Suburban<br>
                                <span style="font-weight: bold;">PASAJEROS:</span> 2<br>
                                <span style="font-weight: bold;">EXTRAS:</span> Botella de Agua<br>
                                <span style="font-weight: bold;">TOTAL:</span> $2400 MXN
                            </td>
                    ...
                    <table cellspacing="0" cellpadding="0" class="arrival-info" style="width: 100%; border: 2px solid #FACC01; font-size: 16px;">
                        <tr>
                            <td style="padding: 10px;">
                                <span style="font-weight: bold;">FECHA:</span> 2022-01-03<br>
                                <span style="font-weight: bold;">HORA:</span> 12:00<br>
                                <span style="font-weight: bold;">AEROLINEA:</span> NOVAIR<br>
                                <span style="font-weight: bold;">NUMERO DE VUELO:</span> 241<br>
            ...
            <tr>
                <td>
                    <h2 class="title-section" style="background: #FACC01; color: #212529; padding: 5px 10px 5px 10px; margin-bottom: 10px; font-size: 24px;">Metodo de pago: Efectivo</h2>
                </td>
            </tr>
        </table>
    </center>
