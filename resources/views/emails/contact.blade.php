...
<body>
    ...
    <center>
        <table cellspacing="0" cellpadding="0" class="email-content" style="width: 90%; margin-top: 20px; margin-bottom: 20px;">
            <tr>
                <td>
                    <h2 class="title-email" style="text-align: center; margin-top: 10px; margin-bottom: 10px; font-size: 26px;">Solicitud de contacto AG3 Luxury Travel</h2>
                </td>
            </tr>
            <tr>
                <td>
                    <h2 class="title-section" style="background: #FACC01; color: #212529; padding: 5px 10px 5px 10px; margin-bottom: 10px; font-size: 24px;">Informacion del contacto</h2>
                </td>
            </tr>
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="0" class="info-content" style="table-layout: fixed; width: 100%; font-size: 16px;">
                        <tr>
                            <td class="items" style="word-wrap: break-word; border: 2px solid #FACC01; padding: 10px;">
                                <span style="font-weight: bold;">NOMBRE:</span> {{$contact['name']}}<br>
                                <span style="font-weight: bold;">CORREO:</span> {{$contact['email']}} <br>
                                <span style="font-weight: bold;">TELEFONO:</span> {{$contact['phone']}} <br>
                                <span style="font-weight: bold;">ASUNTO:</span> {{$contact['subject']}} <br>
                                <span style="font-weight: bold;">CONTENIDO:</span> {{$contact['content']}} <br>
